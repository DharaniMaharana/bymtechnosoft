...
function Edit(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    getBorders = props.attributes.borders;
  });
  const onChangeBorders = newBorders => {
    setAttributes({
      borders: newBorders
    });
  };
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"wptravel/icon-picker","version":"0.1.0","title":"Icon Picker","category":"wp-travel-blocks","icon":"info","description":"Example static block scaffolded with Create Block tool.","supports":{"html":false},"textdomain":"icon-picker","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
